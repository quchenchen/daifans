...
//移动端标题字体大小
$mobile_title_font_size = ot_get_option('mobile_title_font_size','22px');
//移动端内容字体大小
$mobile_content_font_size = ot_get_option('mobile_content_font_size','18px');
...
@media screen and (max-width: 480px){
	...
	article p,.content,.content a,.content li,single-content,single-text,single-content a,.sg-cp p,.widget,.widget a{font-size:<?php echo $mobile_content_font_size;?> !important;}
	.single-text a{font-size:18px !important;}
}
