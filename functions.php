...
$match_num_to = 2;		//一篇文章中同一個標籤最多自動鏈接幾次
...
function post_to_sina_weibo($post_ID) {
  ...
  if ($get_post_info->post_status == 'publish' && $_POST['original_post_status'] != 'publish') {
      $appkey='3317562381'; /* 此处是你的新浪微博appkey！ */
      $username='epubcc@gmail.com';
      $userpassword='epuber123';
      $request = new WP_Http;
      $keywords = "";
    ...
    $string1 = '文章精选:' . strip_tags( $get_post_title ).'：';
    $string2 = ' 全文：'.get_permalink($post_ID);
